...
C) 影片結構拆解 — 分析這支影片「實際使用了」什麼鉤子、痛點、展示手法：
- video_hook：影片前 2-3 秒如何吸引注意力？具體描述畫面、聲音、台詞。
- video_pain：影片如何揭露痛點？用了什麼場景、語氣、情緒？
- video_show：影片如何展示產品/解決方案？用了什麼證據、轉變、CTA？

D) 10/10/10 廣告選單 — 受此影片「啟發」，為同類產品生成 10 個全新的鉤子、10 個痛點、10 個展示（3ZeBra 風格）
...
請回傳以下 JSON 格式（不要加 markdown 標記）：
{
  ...
  "video_hook": "這支影片實際使用的鉤子手法：前 2-3 秒的畫面、聲音、台詞、為什麼有效。",
  "video_pain": "這支影片實際揭露痛點的手法：場景、語氣、情緒、具體台詞。",
  "video_show": "這支影片實際展示產品的手法：展示方式、證據、轉變、CTA。",
  "hooks": [
...
規則：
- video_hook、video_pain、video_show 必須描述「這支影片實際做了什麼」，不是建議，是事實分析。
